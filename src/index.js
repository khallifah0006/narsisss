...
const StoryPresenter = {
  ...
  async renderHome() {
    ...
    const element = document.querySelector('.some-element'); // Change to your actual selector
    ...
    try {
      ...
      if (element) {
        element.remove();  // ✅ Only remove if the element exists
    } else {
    ...
    handleRouteChange() {
      ...
      const render = routes[hash] || (() => {
        document.getElementById('app').innerHTML = '<h2>Page Not Found</h2><p>Return to <a href="#/">Home</a></p>';
      });
